...
IF(WITH_OPENSSL)
  ...
  ENDIF(NOT WITH_ZLIB)
ELSE(WITH_OPENSSL)
  SET(WITH_OPENSSL OFF CACHE BOOL "Build with OpenSSL support" FORCE)
  SET(WITH_ZLIB OFF CACHE BOOL "Build with zlib support" FORCE)
ENDIF(WITH_OPENSSL)
...
SET(CPP_DRIVER_LIBRARY_DIR ${CPP_DRIVER_INSTALL_DIR}/lib)
IF(WIN32)
  SET(CPP_DRIVER_LIBRARY cassandra)
ELSE(WIN32)
  SET(CPP_DRIVER_LIBRARY libcassandra)
ENDIF(WIN32)
SET(CPP_DRIVER_STATIC_LIBRARY ${CPP_DRIVER_LIBRARY}_static)
SET(CPP_DRIVER_LIBRARIES ${CPP_DRIVER_LIBRARY_DIR}/${CPP_DRIVER_LIBRARY}.${CPP_DRIVER_LIBRARY_SUFFIX})
SET(CPP_DRIVER_STATIC_LIBRARIES ${CPP_DRIVER_LIBRARY_DIR}/${CPP_DRIVER_STATIC_LIBRARY}.${CPP_DRIVER_LIBRARY_SUFFIX})
...
IF(NOT CPP_DRIVER_FOUND)
  ...
  EXTERNALPROJECT_GET_PROPERTY(${CPP_DRIVER_LIBRARY_NAME} SOURCE_DIR)
  SET(CPP_DRIVER_SOURCE_DIR ${SOURCE_DIR}/src CACHE STRING "DataStax C/C++ Driver Source Directory" FORCE)
