...
ELSE(NOT CPP_DRIVER_VERSION)
  SET(CPP_DRIVER_ARCHIVE_NAME ${CPP_DRIVER_VERSION})
  IF(LIBUV_VERSION)
    IF(CPP_DRIVER_VERSION STREQUAL "master" OR CPP_DRIVER_VERSION VERSION_EQUAL 2.1.0 OR CPP_DRIVER_VERSION VERSION_GREATER 2.1.0)
      SET(LIBUV_VERSION v1.6.0)
    ELSE(CPP_DRIVER_VERSION STREQUAL "master" OR CPP_DRIVER_VERSION VERSION_EQUAL 2.1.0 OR CPP_DRIVER_VERSION VERSION_GREATER 2.1.0)
      SET(LIBUV_VERSION v1.5.0)
    ENDIF(CPP_DRIVER_VERSION STREQUAL "master" OR CPP_DRIVER_VERSION VERSION_EQUAL 2.1.0 OR CPP_DRIVER_VERSION VERSION_GREATER 2.1.0)
  ENDIF(LIBUV_VERSION)
...
SET_SOURCE_FILES_PROPERTIES(${CPP_DRIVER_INCLUDE_FILES} GENERATED)
