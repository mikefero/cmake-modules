...
IF(NOT LIBUV_VERSION)
  SET(LIBUV_VERSION master)
  SET(LIBUV_ARCHIVE_NAME ${LIBUV_VERSION})
ELSE(NOT LIBUV_VERSION)
  SET(LIBUV_ARCHIVE_NAME v${LIBUV_VERSION})
...
# Determine if debug or release configuration should be used
  ...
  FILE(APPEND ${LIBUV_INSTALL_SCRIPT} "ECHO %CD% > directory.log\"\r\n")
  IF(CMAKE_BUILD_TYPE MATCHES DEBUG)
    FILE(APPEND ${LIBUV_INSTALL_SCRIPT} "XCOPY /E /Y /Q Debug\\lib \"${LIBUV_LIBRARY_DIR}\"\r\n")
  ELSE(CMAKE_BUILD_TYPE MATCHES DEBUG)
    FILE(APPEND ${LIBUV_INSTALL_SCRIPT} "XCOPY /E /Y /Q Release\\lib \"${LIBUV_LIBRARY_DIR}\"\r\n")
  ENDIF(CMAKE_BUILD_TYPE MATCHES DEBUG)
...
SET_SOURCE_FILES_PROPERTIES(${LIBUV_INCLUDE_FILES} GENERATED)
