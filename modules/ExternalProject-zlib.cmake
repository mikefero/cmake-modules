...
IF(NOT ZLIB_VERSION)
  SET(ZLIB_VERSION master CACHE STRING "zlib version" FORCE)
  SET(ZLIB_ARCHIVE_NAME ${ZLIB_VERSION} CACHE STRING "zlib archive version" FORCE)
ELSE(NOT ZLIB_VERSION)
  SET(ZLIB_ARCHIVE_NAME v${ZLIB_VERSION} CACHE STRING "zlib archive version" FORCE)
...
IF(NOT INSTALL_PREFIX)
  SET(INSTALL_PREFIX "${CMAKE_BINARY_DIR}/libs" CACHE STRING "zlib intall prefix" FORCE)
...
IF(ZLIB_VERSION MATCHES master)
  SET(ZLIB_VERSION_DISPLAY master CACHE STRING "zlib version" FORCE)
...
# Determine if zlib has already been found/included
IF(NOT ZLIB_FOUND)
  ...
  # Indicate zlib has been included
  SET(ZLIB_FOUND ON CACHE BOOL "zlib Found" FORCE)
...
SET_SOURCE_FILES_PROPERTIES(${ZLIB_INCLUDE_FILES} PROPERTIES GENERATED TRUE)
